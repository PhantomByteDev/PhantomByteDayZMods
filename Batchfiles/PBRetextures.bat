...
set serverMod=
set currentMod=%pathmods%\@PBRetextures;
...
start %gamepath%\DayZ_x64.exe /min "-mod=%allclientmods%%currentMod%" "-connect=127.0.0.1" "-port=2302" "-profiles=%profileFolder%" "-name=PhantomByte" "-NoBattlEye" "-newErrorsAreWarnings=1"