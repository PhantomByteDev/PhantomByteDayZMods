...
set serverMod=
set currentMod=%pathmods%\@FinalFrontierServerPack;
set servercfg=K:\DayZ\Projects\FinalFrontier\Git\FinalFrontierServerPack

set missionPathch=K:\DayZ\Projects\FinalFrontier\Git\FinalFrontierServerPack\mpmissions\dayzOffline.chernarusplus
